...
router.route("/year").get(userController.getYear).post(userController.postYear);
...
router.route("/user/follows").get(verifyToken, userController.getUserFollow);

router.route("/user/:deckID").post(verifyToken, userController.shareDeck);
...
router.route("/user/years").get(verifyToken, userController.getUserYear);
